...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // Check if student already has an appointment with this professor at the same time
      ...
      if (existingAppointment) {
        ...
        return res
          ...
          .json({
            message:
              "You already have an appointment with this professor at this time",
          });
      }
...
router.put("/:appointmentId/cancel", protect, async (req, res) => {
  const session = await mongoose.startSession();
  session.startTransaction();
